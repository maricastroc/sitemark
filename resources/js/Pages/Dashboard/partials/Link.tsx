...
export function Link({ link }: LinkComponentProps) {
  ...
  return (
    <div className="w-full overflow-x-auto lg:overflow-x-hidden lg:max-w-[60rem] flex items-center justify-between gap-4 p-4 rounded-lg bg-background-secondary">
      <div className="flex items-center flex-grow w-screen gap-3">
        ...
        <div className="flex flex-col w-full gap-1">
          <div className="flex items-center gap-2">
            ...
            <span className={`flex items-center h-2 p-[0.65rem] rounded-full ${getTagColor(link.platform)}`}>
        ...
        <Dialog.Root open={isEditLinkModalFormOpen}>
          <Dialog.Trigger asChild>
            <button
              ...
              className="flex items-center justify-center p-2 text-content-primary"
            >
